...
class EngraveCutter:
    ...
    def __init__(self, cutter, trimesh_models, contour_model, path_processor,
        ...
        print "TG_DEBUG:", cutter
        print "TG_DEBUG:", trimesh_models
        print "TG_DEBUG:", contour_model
        print "TG_DEBUG:", path_processor
        print "TG_DEBUG:", clockwise
        print "TG_DEBUG:", physics
        self.cutter = cutter
    ...
    def GenerateToolPath(self, minz, maxz, horiz_step, dz, draw_callback=None):
        print "TG_DEBUG:", minz
        print "TG_DEBUG:", maxz
        print "TG_DEBUG:", horiz_step
        print "TG_DEBUG:", dz
        print "TG_DEBUG:", draw_callback
